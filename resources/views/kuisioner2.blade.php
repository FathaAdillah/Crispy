                                        ...
                                        <div class="container">
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($questions as $variableId => $variableQuestions)
                                                        @foreach ($variableQuestions as $index => $question)
                                                            <tr>
                                                                <th>{{ $questionNumber++ }}</th>
                                                                <th colspan="6">{{ $question->question }}</th>
                                                            </tr>
                                                            ...
                                                            @foreach (['Tingkat Kepentingan' => '1', 'Tingkat Kinerja' => '2'] as $category => $categoryId)
                                                                <tr class="variable-row">
                                                                    <td></td>
                                                                    <td>{{ $category }}</td>
                                                                    <td><input type="radio"
                                                                            name="responses[{{ $question->id }}][{{ $categoryId }}]"
                                                                            value="1" required></td>
                                                                    <td><input type="radio"
                                                                            name="responses[{{ $question->id }}][{{ $categoryId }}]"
                                                                            value="2" required></td>
